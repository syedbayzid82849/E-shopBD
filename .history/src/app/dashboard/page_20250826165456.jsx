...
export default function Dashboard() {
  ...
  const menuItems = [
    ...
    { name: "Add Product", href: "/dashboard/add-products" }, // handled by modal
    ...
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      ...
      {showAddModal && (
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg w-full max-w-lg p-6 max-h-[80vh] overflow-y-auto">
            ...
            >
              ...
              <div className="flex justify-end space-x-2">
                <button
                  ...
                  className="px-3 py-2 rounded-md bg-gray-300 dark:bg-gray-600"
                >
                  Cancel
                </button>
                <button
