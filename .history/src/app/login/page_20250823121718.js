...
export default function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        console.log('17', email, password);
        convertSegmentPathToStaticExportFilename.("credentials", { email, password });
    };
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 border text-black rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"
                            required
                        />
                    </div>
