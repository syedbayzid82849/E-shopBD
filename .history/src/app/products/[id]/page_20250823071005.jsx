...
export default async function ProductDetailPage({ params }) {
    ...
    return (
        <div className="bg-gray-100 min-h-screen mt-4  font-sans">
            <div className="container mx-auto max-w-7xl px-20 py-8 md:py-16">
                <div className="flex flex-col lg:flex-row gap-8 bg-white p-6 rounded-lg shadow-md">
                    ...
                    <div className="lg:w-1/2 flex flex-col items-center">
                        <div className="w-full aspect-square relative mb-4 flex justify-center ">
                            <Image
                                ...
                                width={600}
                                height={600}
                                className="rounded-lg object-cover  border-2 border-gray-400"
                            />
                        </div>
                    ...
                    <div className="lg:w-1/2">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 mb-6">
                            <button className="flex-1 bg-blue-600 text-white font-bold py-3 rounded-lg shadow-lg hover:bg-blue-700 transition duration-300">
                                Add to Cart
                            </button>
