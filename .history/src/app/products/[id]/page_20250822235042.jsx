                ...
                <div className="flex flex-col lg:flex-row gap-8 bg-white p-6 rounded-lg shadow-md">
                    ...
                    <div className="lg:w-1/2">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 mb-6">
                            <button onClick={() => alert("Added to cart")} className="flex-1 bg-blue-600 text-white font-bold py-3 rounded-lg shadow-lg hover:bg-blue-700 transition duration-300">
                                Add to Cart
                            </button>
                            <button onClick={() => alert("Buying now")} className="flex-1 bg-red-600 text-white font-bold py-3 rounded-lg shadow-lg hover:bg-red-700 transition duration-300">
                                Buy Now
                            </button>
                        </div>
                    </div>
