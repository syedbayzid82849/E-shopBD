...
// ⭐ StarRating (Client component হতে পারে)
function StarRating({ averageRating, totalStars = 5 }) {
    return (
...
// 👉 Server Component (database call allowed here)
            ...
            <div className="container mx-auto max-w-7xl px-4 py-8 md:py-16">
                <div className="flex flex-col lg:flex-row gap-8 bg-white p-6 rounded-lg shadow-md">
                    ...
                    <div className="lg:w-1/2 flex flex-col items-center">
                        <div className="w-full aspect-square relative mb-4 flex justify-center ">
                            <Image
                                src={product.images?.[0] || product.thumbnail || "/default.png"}
                                alt={product.title}
                                width={600}
                                height={600}
                                className="rounded-lg object-cover w-[300px] h-[300px] border-2 border-black"
                            />
                        </div>
                        <div className="flex gap-2 justify-center flex-wrap mt-0">
                    ...
                    <div className="lg:w-1/2">
                        ...
                        <div className="flex gap-2 mb-3">
                            {product.badges?.map((badge, i) => (
                                <span key={i} className="bg-blue-600 text-white text-xs px-2 py-1 rounded-full font-medium">
                                    {badge}
                                </span>
                            ))}
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 mb-6">
                            <button
                                ...
                                className="flex-1 bg-blue-600 text-white font-bold py-3 rounded-lg shadow-lg hover:bg-blue-700 transition duration-300"
                            >
                                Add to Cart
                            </button>
                            ...
                            <button
                                ...
                                className="flex-1 bg-red-600 text-white font-bold py-3 rounded-lg shadow-lg hover:bg-red-700 transition duration-300"
                            >
                                Buy Now
                            </button>
                        </div>
