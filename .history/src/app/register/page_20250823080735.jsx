...
export default function Register() {
    ...
    return (
        <div className="bg-gray-100 min-h-screen pt-10 flex items-center justify-center px-4 font-sans">
            <div className="w-full max-w-4xl grid items-center p-8 bg-white shadow-lg rounded-xl">
