...
export default function Register() {
    ...
    return (
        <div className="bg-gray-100 min-h-screen py-10 flex items-center justify-center font-sans">
            <div className="md:w-1/3 grid items-center p-2 py-8 bg-white shadow-lg rounded-xl">
