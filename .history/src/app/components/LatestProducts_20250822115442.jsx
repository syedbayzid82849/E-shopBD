...
// আপনার products.json ফাইল থেকে ডেটা সরাসরি লোড করা হচ্ছে।
// যেহেতু কোডটি ব্রাউজারে চলবে, তাই ফাইলটি সরাসরি ইম্পোর্ট করা যাবে না।
// তাই ডেমো হিসেবে আমরা ডেটা সরাসরি এখানে পেস্ট করেছি।
const products = [
    {
        sku: "SKU-100001",
...
export default function LatestProducts() {
    return (
        <div className="bg-gray-100 px-4 import React from 'react';
...
export default function App() {
  return (
    <div className="bg-gray-100 p-8 sm:p-12 md:p-16 lg:p-20 font-sans">
 ...
 mt-16  font-sans max-w-7xl mx-auto">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold mb-8 text-gray-800">
                Latest Products
            </h2>
