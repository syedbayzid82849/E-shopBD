...
export default async function LatestProducts() {
    ...
    const products = await productsCollection.find().toArray({ sort: { createdAt: -1 } });
                            ...
                            >
                                ...
                                <div className="w-full h-48 md:h-56 lg:h-64 overflow-hidden">
                                    <Image
                                        ...
                                        width={300}
                                        height={200}
                                        className="w-full h-full object-cover bg-gray-400 group-hover:scale-105 transition-transform duration-300"
                                    />
                                </div>
