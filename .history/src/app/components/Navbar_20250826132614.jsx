...
export default function Navbar() {
            ...
            <>
                ...
                </li>
                {
                    sessionStatus === "authenticated" && (
                        <li>
                            <Link href="/deshboard" className={isActive("/dashboard")}>
                                Dashboard
                            </Link>
                        </li>
                    )
    ...
    return (
        <div className="navbar bg-amber-50 shadow-sm fixed z-50 md:px-6">
            ...
            <div className="navbar-end">
                {session?.status === 'authenticated' ? (
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <Link
                            href="/register"
                            className="w-30 bg-blue-600 text-white py-1 rounded hover:bg-blue-700 text-center"
                        >
                            Get Started
                        </Link>
                    </div>
